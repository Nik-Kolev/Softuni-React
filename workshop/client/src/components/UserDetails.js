...
export const UserDetails = ({ firstName, lastName, email, imageUrl, createdAt, phoneNumber, _id, address, updatedAt, onInfoClose }) => {
    return (
                ...
                <div className='detail-container'>
                    ...
                    <div className='content'>
                        ...
                        <div className='user-details'>
                            ...
                            <p>
                                Modified on: <strong>{convertDate(updatedAt)}</strong>
                            </p>
                        </div>
                    </div>
                </div>
